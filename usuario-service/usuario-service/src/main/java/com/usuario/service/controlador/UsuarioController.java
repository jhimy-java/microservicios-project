...
public class UsuarioController {
    ...
    {
        return new ResponseEntity("El usuario : " + id + "tiene dinero para los carros", HttpStatus.OK);
    }
    ...
    {
        return new ResponseEntity("El usuario : " + id + "tiene dinero para las motos", HttpStatus.OK);
    }

    private ResponseEntity<Map<String, Entity>> fallBackGetTodos(@PathVariable("usuarioId") int id, RuntimeException exception)
    {
